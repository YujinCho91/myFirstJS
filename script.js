...
// const koalasScore = (89 + 91 + 110) / 3;

// if (dolphinScore > koalasScore) {
//   console.log("Dolphin wins a trophy");
// } else if (dolphinScore < koalasScore) {
//   console.log("Koala wins a trophy");
// } else if (dolphinScore === koalasScore) {
...
//   (dolphinScore >= 100) & (koalasScore >= 100)
// ) {
//   console.log("Both win the trophy");
// } else {
...
// const me = "Jonas";
// console.log(`I'm ${2027 - 1991} yeears old ${me}`);
